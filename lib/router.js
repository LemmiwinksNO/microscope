...
Router.configure({
  ...
  // router will ensure that the posts subscription is loaded before sending
  // the user through to the route they requested.
...
Router.onBeforeAction(function() { clearError() });